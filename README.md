...
> The procedure for setting the NetLogo path has changed. If you are
> using the CRAN version of `logolink` (version 0.1.0). Click
...
#> Rows: 110,110
#> Columns: 10
#> $ run_number             <dbl> 5, 9, 6, 8, 7, 2, 1, 4, 3, 4, 1, 3, 2, 8, 9,…
