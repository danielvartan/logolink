...
`logolink` will try to find out the path to the NetLogo installation automatically, but **if it fails**, you will need to set it manually. In the latter case, see the documentation of the [`run_experiment`](https://danielvartan.github.io/logolink/reference/run_experiment.html) function for more details.
