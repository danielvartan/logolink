...
`logolink` also provides functions to capture screenshots of the NetLogo world during the simulation. This is useful for capturing special states and for preparing materials for publication.
