...
`logolink` is an [R](https://www.r-project.org/) package that makes it easy to set up and run [NetLogo](https://www.netlogo.org/) simulations directly from R. It is built for NetLogo 7 and does not support older versions.

The package takes a modern, streamlined approach to running NetLogo models. It follows the [tidyverse
principles](https://tidyverse.tidyverse.org/articles/manifesto.html) and integrates naturally with the [tidyverse ecosystem](https://www.tidyverse.org/).
