...
We assume you're already familiar with [NetLogo](https://www.netlogo.org) and have version 7.0.1 or above installed. You should also be comfortable with R programming, particularly with the [tidyverse](https://tidyverse.org/) ecosystem.
